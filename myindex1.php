							...
							<div class="col-md-3 col-12 mb-md-4 mb-2">
								<div class="card shadow">
									...
									<div class="card-body">
										...
										<a href="javascript:void(0)" class="btn text-light addtocart" data-id="<?=$brand['id']?>" data-name="<?=$brand['name']?>" data-photo="<?=$brand['logo']?>" style="background-color: #F8A145;"><i class="fas fa-shopping-cart mr-2"></i>Add to Cart</a>
									</div>
								</div>
							</div>
						<?php }}?>
