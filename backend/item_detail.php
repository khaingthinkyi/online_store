...
<div class="container-fluid">
	...
	<div class="d-sm-flex align-items-center justify-content-between mb-4">
		...
		<a href="item_create.php" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fal fa-backward"></i>Go Back</a>
	</div>
	<div class="card">
		...
		<div class="card-body">
			<div class="row">
				...
				<div class="col-md-8">
					...
					<h5>BRAND:<span class="text-dark"><?=$item['brand_name']?></span></h5>
