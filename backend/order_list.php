				...
				<table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
					...
					<tbody>
						...
						<tr>
							...
							<td><?=$order['total']?></td>
							<td><a href="orderdetail.php?voucherno=<?=$order['voucherno']?>" class="btn btn-primary btn-sm">Detail</a><a href="confirm.php?id=<?=$order['id']?>" class="btn btn-success btn-sm">Confirm</a>
							</td>
						</tr>
						<?php } ?>
					</tbody>
